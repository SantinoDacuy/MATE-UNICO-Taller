...
export interface ApiCuponCupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cupon.cupon'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tipo_descuento: Schema.Attribute.Enumeration<['porcentaje']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valor_decuento: Schema.Attribute.Integer;
  };
}
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    id_venta: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Enumeration<
      ['mate', 'combo_simple', 'combo_completo']
    >;
    color_blanco: Schema.Attribute.Boolean;
    color_gris: Schema.Attribute.Boolean;
    color_marron: Schema.Attribute.Boolean;
    color_negro: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
